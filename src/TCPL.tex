...
{\noindent\Huge\bfseries Notes Collection of \\[0.5\baselineskip] C Programming Language}\\[2\baselineskip] % Title
{\large \textit{C Programming Language}}\\[4\baselineskip] % Tagline or further description
...
\title{{\zihao{1}}The C Programming Language}
